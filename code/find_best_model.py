...
for i in range(1,26):
    ...
    command = 'python test_hopenet.py --dataset BIWI --data_dir ./datasets/BIWI/test --filename_list ./datasets/BIWI/test/biwi_test.txt --snapshot output/snapshots/_epoch_'+str(i)+'.pkl  --arch Squeezenet_1_0'
