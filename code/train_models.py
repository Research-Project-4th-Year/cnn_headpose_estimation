...
for arch in architectures:
    ...
    #command = 'python train_hopenet.py --dataset BIWI --data_dir ./datasets/BIWI --lr 0.00001 --alpha 1 --batch_size 16 --num_epochs 100 --w_dist 15.0 --w_angle 40.0  --kd_alpha_dynamic True --arch ' + arch

    #Train with exchange student and teacher loss
    command = 'python train_hopenet.py --dataset BIWI --data_dir ./datasets/BIWI --lr 0.00001 --alpha 1 --batch_size 16 --num_epochs 100 --w_dist 20.0 --w_angle 45.0 --change_t_s True  --arch ' + arch
