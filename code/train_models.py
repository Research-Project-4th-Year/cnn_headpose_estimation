...
for arch in architectures:
    ...
    #command = 'python train_hopenet.py --dataset BIWI --data_dir ./datasets/BIWI --lr 0.00001 --alpha 1 --batch_size 16 --num_epochs 100  --kd_alpha_dynamic True --arch ' + arch

    #Train with exchange student and teacher loss
    command = 'python train_hopenet.py --dataset BIWI --data_dir ./datasets/BIWI --lr 0.00001 --alpha 1 --batch_size 16 --num_epochs 100 --change_t_s True  --arch ' + arch
