...
class SeResNeXt_HopeNet(nn.Module):

    def __init__(self, block, layers, cardinality=32, num_classes=66):
        super(SeResNeXt_HopeNet, self).__init__()
...
def se_resnext50(**kwargs):
    ...
    """
    model = SeResNeXt_HopeNet(Bottleneck, [3, 4, 6, 3], **kwargs)
    #model = SeResNeXt(torchvision.models.resnet.Bottleneck, [3, 4, 6, 3], num_classes=66)
    return model
